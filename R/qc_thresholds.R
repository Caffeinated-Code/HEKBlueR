...
qc_threshold_recommendations <- function() {
  data.frame(
    input_id = c(
      ...
      "outlier_rate_warn_percent", "replicate_cv_warn_percent", "replicate_cv_fail_percent",
    ...
    label = c(
      ...
      "Outlier rate warning (%)", "Primary replicate CV warning (%)", "Primary replicate CV fail (%)",
    ...
    default = c(0.5, 0, 20, 0.15, 0.15, 20, 0.15, 5, 25, 50, 8, 5, 30, 30, 0.2, 4, 0.7, 0.25, 0.4, 0.35),
    safe_min = c(0.3, -0.5, 5, 0.05, 0.03, 5, 0.05, 1, 10, 25, 6, 4, 10, 10, 0.1, 2, 0.3, 0.05, 0.05, 0.05),
    safe_max = c(0.8, 0.4, 35, 0.35, 0.5, 35, 0.35, 15, 40, 80, 12, 7, 60, 50, 0.5, 6, 1.5, 1, 1, 1),
    rationale = c(
